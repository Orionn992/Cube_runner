...
namespace GreatArcStudios
{
    public class PauseManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// This is the level select panel holder
        /// </summary>
        public GameObject levelPanel;

        /// <summary>
        /// Level Panel animator
        /// </summary>
        public Animator levelPanelAnimator;

        /// <summary>
        /// Default selected object for level panel
        /// </summary>
        public GameObject defualtSelectedLevel;
        ...
        */
        ...
        public void Update()
        {
            if (Input.GetKeyDown(KeyCode.Escape) && levelPanel.activeSelf)
            {
                BackFromLevel();
                return;
            }
            ...
            else if (levelPanel.active == true)
            {
                pauseMenu.text = "Select Level";
            }
            ...
            if (!isMainMenu && Input.GetKeyDown(KeyCode.Escape) && mainPanel.active == false)
            {
                uiEventSystem.SetSelectedGameObject(defualtSelectedMain);
                mainPanel.SetActive(true);
                vidPanel.SetActive(false);
            ...
            else if (!isMainMenu && Input.GetKeyDown(KeyCode.Escape) && mainPanel.active == true)
            {
                Time.timeScale = timeScale;
                mainPanel.SetActive(false);
                vidPanel.SetActive(false);
        ...
        {
            mainPanel.SetActive(false); // ← Убедись что есть
            vidPanel.SetActive(false);
            audioPanel.SetActive(false);
            levelPanel.SetActive(true);
            if (levelPanelAnimator != null)
            {
                levelPanelAnimator.enabled = true;
                levelPanelAnimator.Play("Level Panel In");
            }
            uiEventSystem.SetSelectedGameObject(defualtSelectedLevel);
            pauseMenu.text = "Select Level";
        }
        ...
        public void BackFromLevel()
        {
            if (levelPanelAnimator != null)
            {
                levelPanelAnimator.Play("Level Panel Out");
            }
            levelPanel.SetActive(false);
            mainPanel.SetActive(true);
            uiEventSystem.SetSelectedGameObject(defualtSelectedMain);
        ...
        // =======================================
        // LEVEL PANEL APPLY / CANCEL (INSTANT)
        // =======================================
        public void applyLevel()
        {
            CloseLevelPanelInstant();
        }
        ...
        private void CloseLevelPanelInstant()
        {
            if (levelPanelAnimator != null)
            {
                levelPanelAnimator.Play("Level Panel Out");
